...
(form/defsc-form LineItemForm [this props]
  {::form/id            line-item/id
   ::form/attributes    [line-item/category line-item/item line-item/quantity line-item/quoted-price line-item/subtotal]
   ::form/validator     model/all-attribute-validator
   ::form/cancel-route  ["landing-page"]
   ::form/route-prefix  "line-item"
   ::form/title         "Line Items"
   ::form/layout        [[:line-item/category :line-item/item :line-item/quantity :line-item/quoted-price :line-item/subtotal]]
   ...
   ::form/field-options {:line-item/category {::picker-options/query-key       :category/all-categories
